      ...
      <div className="fixed w-full max-w-[100vw] h-16 z-50 bg-background border-b-2 border-input">
        <div className="flex items-center justify-between h-full px-3 mx-auto md:px-1 max-w-screen-3xl md:gap-20">
          ...
          <Navigation
            ...
            ulClass={` duration-500 ${
              navOpen ? "translate-x-0" : "translate-x-80 "
            } border-l border-input flex flex-col h-screen bg-background w-60 top-0 right-0 absolute items-center justify-between gap-10 pb-8 pt-24`}
          />
        </div>
      </div>
    </>
